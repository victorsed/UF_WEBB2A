...
class Product
{
    ...
    public static function loadValidatorMetadata(ClassMetadata $metadata)
    {
        ...
        $metadata->addPropertyConstraint('vskey', new Assert\Type('string'));
        $metadata->addPropertyConstraint('vskey', new Assert\NotNull());
    ...
    public function getVskey(): ?string
    {
        return $this->vskey;
    }

    public function setVskey(string $vskey): self
    {
        $this->vskey = $vskey;
