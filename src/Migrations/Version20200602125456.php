 ...
 */
final class Version20200602125456 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE products (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, category VARCHAR(255) NOT NULL, stock INT NOT NULL, price NUMERIC(10, 2) NOT NULL, weight NUMERIC(10, 3) NOT NULL, vskey LONGTEXT NOT NULL, date_created DATETIME NOT NULL, deleted_at DATETIME NOT NULL, slug VARCHAR(191) NOT NULL, UNIQUE INDEX uniq_slug_softdelete (slug, deleted_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
